...
export async function getById(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const program = await service.findById(parsed.data);
    res.json({ data: program } satisfies SingleResponse<typeof program>);
  } catch (err) {
    next(err);
  }
}
...
export async function create(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: CreateProgramDto = result.data;
    const program = await service.create(dto);
    res.status(201).json({ data: program } satisfies SingleResponse<typeof program>);
  } catch (err) {
    next(err);
  }
}
...
export async function update(req: Request, res: Response, next: NextFunction): Promise<void> {
  try {
    ...
    const dto: UpdateProgramDto = result.data;
    const program = await service.update(parsedId.data, dto);
    res.json({ data: program } satisfies SingleResponse<typeof program>);
  } catch (err) {
    next(err);
  }
